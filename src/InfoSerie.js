  ...
  return (
    <div>
      ...
      <div className='container'>
        <button className='btn btn-outline-primary' onClick={() => setMode('EDIT')}>Editar</button>
      </div>
      {
        mode === 'EDIT' &&
          <div className='container'>
            <h1>Editar Série</h1>
            <button className='btn btn-outline-secondary' onClick={() => setMode('INFO')}>Cancelar</button>
            <form>
              ...
              <div className='form-group'>
                ...
                <input type='text' value={form.comments} onChange={onChange('comments')} className='form-control' id='name' placeholder='Comentario' />
              </div>
              <div className='form-group'>
                <label htmlFor='name'>Gênero</label>
                <select className='form-control' onChange={onChangeGenre} value={genreId.name}>
